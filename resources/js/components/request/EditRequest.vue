  ...
  <b-container class="mt-2 mb-2">
    ...
    <b-form @submit="handleSubmit">
      <b-card header="Edit Affair">
        ...
        <b-form-group label="Affair Type" label-for="affair-type-input">
                ...
                <b-row>
                  <b-col cols="12" md="6">
                    <b-form-group
                      ...
                      :label-for="
                        'procedure-' + procedure_index + '-description'
                      "
                    >
                      <b-form-input
                    ...
                    <b-form-group
                      ...
                      :label-for="
                        'request-responsible-bureau-input-' + procedure_index
                      "
