        ...
        <b-card class="content" >
            <b-row>
                <b-col cols="" class="text-center">
                    <b-dropdown id="dropdown-right" right text="Edit" variant="primary" class="edit_button ml-5">
                        <b-dropdown-item v-b-modal.edit-account-modal>Edit Profile</b-dropdown-item>
                    ...
                    <a href="javascript:;">
                        ...
                        fluid
                        rounded="circle"
                        class="img-right shadow shadow-lg--hover mb-4" style="width: 15rem;" />
                    </a>
                    <h5 class="h3 title">
                        <small class="h4 font-weight-light text-muted">{{userProfile.user_name}}</small>
                        <span class="d-block mb-1">{{userProfile.first_name}} {{userProfile.last_name}}</span>
                    </h5>
                    <b-list-group class="text-left" flush>
                        <b-list-group-item><b>First Name: </b>{{userProfile.first_name}}</b-list-group-item>
                        <b-list-group-item><b>Last Name: </b>{{userProfile.last_name}}</b-list-group-item>
                        <b-list-group-item><b>Email: </b>{{userProfile.email}}</b-list-group-item>
                        <b-list-group-item><b>Phone Number: </b>{{userProfile.phone}}</b-list-group-item>
                    </b-list-group>
                    <div>
                        <b-modal
                            ...
                            <form ref="form" @submit.prevent="editProfile">
                                ...
                                >
                                    <b-form-input
                                        ...
                                        name="first_name"
                                        class="form-control"
                                        :class="{ 'is-invalid': profileSubmitted && $v.userProfile.first_name.$error, 'is-valid': !$v.userProfile.first_name.$invalid }" 
                                    >
                                    </b-form-input>
                                    ...
                                    <div class="invalid-feedback">
                                        <span v-if="profileSubmitted && !$v.userProfile.first_name.required">First name is required.</span>
                                        <span v-if="profileSubmitted && !$v.userProfile.first_name.minLength">First name must have at least {{ $v.userProfile.first_name.$params.minLength.min }} letters</span>
                                        <span v-if="profileSubmitted && !$v.userProfile.first_name.maxLength">First name must have at most {{ $v.userProfile.first_name.$params.maxLength.max }} letters.</span>
                                    </div>
                                </b-form-group>
                                ...
                                >
                                    <b-form-input
                                        ...
                                        name="last_name"
                                        class="form-control"
                                        :class="{ 'is-invalid': profileSubmitted && $v.userProfile.last_name.$error, 'is-valid': !$v.userProfile.last_name.$invalid }" 
                                    >
                                    </b-form-input>
                                    ...
                                    <div class="invalid-feedback">
                                        <span v-if="profileSubmitted && !$v.userProfile.last_name.required">Last name is required.</span>
                                        <span v-if="profileSubmitted && !$v.userProfile.last_name.minLength">Last name must have at least {{ $v.userProfile.last_name.$params.minLength.min }} letters</span>
                                        <span v-if="profileSubmitted && !$v.userProfile.last_name.maxLength">Last name must have at most {{ $v.userProfile.last_name.$params.maxLength.max }} letters.</span>
                                    </div>
                                </b-form-group>
                                ...
                                >
                                    <b-form-input
                                        ...
                                        name="email"
                                        class="form-control"
                                        :class="{ 'is-invalid': profileSubmitted && $v.userProfile.email.$error, 'is-valid': !$v.userProfile.email.$invalid }" 
                                    >
                                    </b-form-input>
                                    ...
                                    <div class="invalid-feedback">
                                        <span v-if="profileSubmitted && !$v.userProfile.email.required">Email required.</span>
                                        <span v-if="profileSubmitted && !$v.userProfile.email.isUnique">Invalid email.</span>
                                    </div>
                                </b-form-group>
                                ...
                                >
                                    <b-form-input
                                        ...
                                        name="phone"
                                        class="form-control"
                                        :class="{ 'is-invalid': profileSubmitted && $v.userProfile.phone.$error, 'is-valid': !$v.userProfile.phone.$invalid }" 
                                    >
                                    </b-form-input>
                                    ...
                                    <div class="invalid-feedback">
                                        <span v-if="profileSubmitted && !$v.userProfile.phone.required">First name is required.</span>
                                        <span v-if="profileSubmitted && !$v.userProfile.phone.minLength">First name must have at least {{ $v.userProfile.phone.$params.minLength.min }} letters</span>
                                        <span v-if="profileSubmitted && !$v.userProfile.phone.maxLength">First name must have at most {{ $v.userProfile.phone.$params.maxLength.max }} letters.</span>
                                    </div>
                                </b-form-group>
                        ...
                        >
                            <form ref="form" @submit.prevent="changePassword">
                                ...
                                <b-form-input
                                    ...
                                    class="form-control" 
                                    :class="{ 'is-invalid': passwordChange && $v.userPassword.current_password.$error, 'is-valid': !$v.userPassword.current_password.$invalid  }"
                                >
                                </b-form-input>
                                ...
                                <b-form-input
                                    ...
                                    name="newPassword"
                                    class="form-control"
                                    :class="{ 'is-invalid': passwordChange && $v.userPassword.password.$error, 'is-valid': !$v.userPassword.password.$invalid  }"
                                ></b-form-input>
                                ...
                                <div v-if="passwordChange && $v.userPassword.password.$error" class="invalid-feedback">
                                    <span v-if="!$v.userPassword.password.required">New password is required.</span>
                                    <span v-if="!$v.userPassword.password.minLength">New password must be at least 8 characters.</span>
                                </div>
                                </b-form-group>
                                ...
                                <b-form-input
                                    ...
                                    class="form-control"
                                    :class="{ 'is-invalid': passwordChange && $v.userPassword.password_confirmation.$error, 'is-valid': !$v.userPassword.password_confirmation.$invalid }"
                                ></b-form-input>
                                ...
                                <!-- Displays Error Message for Password input -->
                                <div class="valid-feedback">Confirmation password match!</div>
                                <div v-if="passwordChange && $v.userPassword.password_confirmation.$error" class="invalid-feedback">
                                    <span v-if="!$v.userPassword.password_confirmation.required">Confirmation password is required.</span>
                                    <span v-else-if="!$v.userPassword.password_confirmation.sameAsPassword">Confirmation password does not match.</span>
                                </div>
                                </b-form-group>
  ...
  export default {
    ...
    methods: {
        editProfile(e){
            ...
            axios.post('/api/account', { ...this.userProfile })
            .then((resp)=>{
        ...
        changePassword(e){
            ...
            axios.post('/api/account/change-password', {...this.userPassword})
                .then((resp) => {
                    console.log(resp.data);
